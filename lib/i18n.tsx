...
const en: Dict = {
  ...
  err_pay_credit_card_insufficient_funds: "You only have {free} unallocated. Please add money to the account.",
...
const tr: Dict = {
  ...
  err_pay_credit_card_insufficient_funds: "Sadece {free} tutarında ayrılmamış paranız var. Lütfen hesaba para ekleyin.",
